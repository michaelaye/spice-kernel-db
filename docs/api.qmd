...
Find rows in `metakernel_registry` whose remote `source_url` returns a permanent HTTP error (403/404/410) and optionally remove them. Sends a HEAD request to each URL with the given `timeout`.
