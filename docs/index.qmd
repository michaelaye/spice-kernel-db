...
![](images/hero.svg){fig-alt="Diagram showing SPICE kernel files (SPK, CK, LSK) flowing through SHA-256 hashing into a DuckDB content-addressed database, with outputs for deduplication, mission-aware resolution, and metakernel rewriting."}
